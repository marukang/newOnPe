...
import com.funidea.newonpe.page.home.class_community_board.board_file_Adapter
...
class class_unit_page : AppCompatActivity() {
    ...
    var boardFileItem = ArrayList<FileItem>()
    //링크
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        boardFileAdapter.setonItemClickListener(object : board_file_Adapter.onItemClickListener
        {
            override fun item_click(position: Int) {
                val intent = Intent(this@class_unit_page, class_file_open_webview_Activity::class.java)
        ...
        classUnitLinkAdapter.setonItemClickListener(object  :
            class_unit_link_Adapter.onItemClickListener
        {
            override fun item_click(position: Int) {
    ...
    val start_button = View.OnClickListener {
        ...
        {
            show(this, "참고자료, 수업링크, 유투브 영상을 확인 후 시작해주세요.")
        }
    }
            ...
            override fun onResponse(call: Call<ResponseBody>, response: Response<ResponseBody>)
            {
                try
                {
                    ...
                    if(!i.next().equals("fail"))
                    {
                        ...
                        SimpleSharedPreferences.saveAccessToken(this@class_unit_page, access_token)
                        ...
                        {
                            boardFileItem.add(FileItem("첨부자료 "+(i+1).toString(),unit_attached_file_JSONArray.get(i).toString()))
                        }
                    ...
                    {
                        show(this@class_unit_page, "인터넷 연결 상태를 확인해주세요.")
                ...
                try {
                    ...
                    if(!i.next().equals("fail"))
                    {
                       ...
                       // access_token = result.getString("student_token")
                        ...
                        {
                            show(this@class_unit_page, "이론 수업만 있는 단원입니다.\n 수업 참석이 완료되었습니다.")
                        }
                        else {

                            val intent = Intent(this@class_unit_page, class_detail_unit_Activity::class.java)
