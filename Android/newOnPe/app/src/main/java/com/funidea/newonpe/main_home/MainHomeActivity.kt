...
import com.funidea.newonpe.home.class_community_menu_Activity
import com.funidea.newonpe.home.class_home.class_home_Activity
import com.funidea.newonpe.my_page.my_page_Activity
import com.funidea.newonpe.my_page.setting_Activity
import com.funidea.newonpe.notice_class.notice_main_home_Activity
import com.funidea.newonpe.self_class.self_class_Activity
...
class MainHomeActivity : AppCompatActivity() {
    ...
    val add_new_class = View.OnClickListener {
        ...
        newClassAddBottomDialog.setInputNewClassCodeListener(object : new_class_add_bottom_dialog.InputNewClassCodeListener
        {
            override fun input_code(input_code: String?) {
                ...
                {
                    custom_toast(this@MainHomeActivity, "이미 등록 된 수업코드입니다.")
                }
                else{
    ...
    private fun tedPermission() {
        val permissionListener: PermissionListener = object : PermissionListener {
            ...
            override fun onPermissionDenied(deniedPermissions: List<String>) {
                ...
                // 권한 요청 거절
                isPermission = false
                custom_toast(this@MainHomeActivity, "권한 거부로 인해 앱이 정상적으로 동작하지 않을 수 있습니다.")
            }
        }
    ...
    val class_enter_button = View.OnClickListener {
        ...
        {
            custom_toast(this, "수업을 듣기 위해서 마이페이지에서 학년, 반, 번호를 입력해주세요.")
            ...
            override fun onResponse(call: Call<ResponseBody>, response: Response<ResponseBody>)
            {
                try {
                    ...
                    else
                    {
                        ...
                        {
                            custom_toast(this@MainHomeActivity, "존재 하는 않는 수업코드입니다. 수업코드를 다시 확인해주세요.")
                        }
                        else{
                            custom_toast(this@MainHomeActivity, "인터넷 연결 상태를 확인해주세요.")
                        }
