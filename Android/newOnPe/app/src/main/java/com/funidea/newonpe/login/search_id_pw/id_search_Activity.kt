...
class id_search_Activity : AppCompatActivity() {
            ...
            override fun onResponse(call: Call<ResponseBody>, response: Response<ResponseBody>) {
                try {
                    ...
                    if(i.next().equals("success"))
                    {
                        ...
                        val intent = Intent(this@id_search_Activity, id_search_complete_Activity::class.java)
                    ...
                    else
                    {
                        ...
                        Toast.makeText(this@id_search_Activity, "이름과 이메일을 다시 확인해주세요.", Toast.LENGTH_SHORT).show()
