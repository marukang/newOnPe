...
class self_class_exercise_name_bottom_dialog(context: Context, selfClassBottomDialogItem : ArrayList<self_class_bottom_dialog_Item>) : BottomSheetDialog(context) {
