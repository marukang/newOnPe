...
import com.funidea.newonpe.home.class_result.class_result_JSONArray_Adapter
import com.funidea.newonpe.home.class_result.class_result_JSONArray_Item
import com.funidea.newonpe.home.class_result.class_result_state_Adapter
import com.funidea.newonpe.home.class_result.class_result_state_Item
...
class complete_exercise_record_Activity : AppCompatActivity() {
            ...
            override fun onResponse(call: Call<ResponseBody>, response: Response<ResponseBody>)
            {
                try {
                    ...
                    if(!i.next().equals("fail"))
                    {
                        ...
                        save_SharedPreferences.save_shard(this@complete_exercise_record_Activity, set_User_info.access_token)
                    ...
                    {
                        Custom_Toast.custom_toast(this@complete_exercise_record_Activity, "수업 정보를 가져오지 못했습니다. 인터넷 연결 상태를 다시 확인해주세요.")
                    }
