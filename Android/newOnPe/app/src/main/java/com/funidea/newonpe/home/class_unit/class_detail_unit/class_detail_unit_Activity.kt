...
import com.funidea.newonpe.PoseActivity
        ...
        classDetailUnitClassListAdapter.setonItemClickListener(object : class_detail_unit_class_list_Adapter.onItemClickListener
        {
            override fun item_click(position: Int)
            {
                    ...
                    poseExerciseStartBottomDialog.setExerciseConfirmListener(object : pose_exercise_start_bottom_dialog.ExerciseConfirmListener{
                        override fun select_confirm(select: String?) {
                            ...
                            if(select.equals("1"))
                            {
                                ...
                                {
                                    custom_toast(this@class_detail_unit_Activity, "이론수업은 운동 콘텐츠가 있지 않습니다.")
                                }
                ...
                if(classDetailUnitClassListItem.get(position).class_unit_title.contains("평가"))
                {
                    ...
                    {
                        custom_toast(this@class_detail_unit_Activity, "최종 제출 완료 된 평가입니다.")
                    }
        ...
        serverConnection!!.get_content_list(student_id, access_token, content_code).enqueue(object : Callback<ResponseBody>
        {
            ...
            override fun onResponse(call: Call<ResponseBody>, response: Response<ResponseBody>)
            {
                ...
                try {
                    ...
                    {
                        custom_toast(this@class_detail_unit_Activity, "인터넷 연결 상태를 확인해주세요.")
            ...
            override fun onResponse(call: Call<ResponseBody>, response: Response<ResponseBody>)
            {
                try {
                    ...
                    if(!i.next().equals("fail"))
                    {
                        ...
                        custom_toast(this@class_detail_unit_Activity, "최종 제출 되었습니다.\n선생님이 요청한 제출방식에 맞추어 제출해주시길 바랍니다.")
                    ...
                    {
                        Custom_Toast.custom_toast(this@class_detail_unit_Activity, "인터넷 연결 상태를 확인해주세요.")
