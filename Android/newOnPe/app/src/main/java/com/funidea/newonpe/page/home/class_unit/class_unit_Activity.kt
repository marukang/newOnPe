...
import com.funidea.newonpe.page.home.class_community_board.board_file_Item
        ...
        serverConnectionSpec!!.student_get_curriculum(student_id, access_token, class_code, unit_class_code).enqueue(object : Callback<ResponseBody> {
            override fun onResponse(call: Call<ResponseBody>, response: Response<ResponseBody>)
            {
                try {
                    ...
                    {
                        show(this@class_unit_Activity, "인터넷 연결 상태를 확인해주세요.")
                ...
                try {
                    ...
                    if(!i.next().equals("fail"))
                    {
                       ...
                       // access_token = result.getString("student_token")
                        ...
                        {
                            show(this@class_unit_Activity, "이론 수업만 있는 단원입니다.\n 수업 참석이 완료되었습니다.")
                        }
                        else {
