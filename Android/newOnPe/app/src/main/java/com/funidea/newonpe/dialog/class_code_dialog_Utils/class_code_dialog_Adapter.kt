...
class class_code_dialog_Adapter(context: Context, classCodeDialogItem : ArrayList<class_code_dialog_Item>?)
    : RecyclerView.Adapter<class_code_dialog_Adapter.ViewHolder>() {

    private val classCodeDialogItem: ArrayList<class_code_dialog_Item>?
    ...
    init {
        this.classCodeDialogItem = classCodeDialogItem
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, position: Int) {
        ...
        val position_item: class_code_dialog_Item = classCodeDialogItem!![position]
    ...
    override fun getItemCount(): Int {
        return classCodeDialogItem?.size ?: 0
    }
}