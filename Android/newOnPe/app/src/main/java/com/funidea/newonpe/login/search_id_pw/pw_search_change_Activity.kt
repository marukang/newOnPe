...
class pw_search_change_Activity : AppCompatActivity() {
            ...
            override fun onResponse(call: Call<ResponseBody>, response: Response<ResponseBody>) {
                try {
                    ...
                    if(i.next().equals("success"))
                    {
                        ...
                        Toast.makeText(this@pw_search_change_Activity, "비밀번호가 변경되었습니다.", Toast.LENGTH_SHORT).show()



                        val intent = Intent(this@pw_search_change_Activity, login_page_Activity::class.java)
                    ...
                    else
                    {
                        ...
                        Toast.makeText(this@pw_search_change_Activity, "실패", Toast.LENGTH_SHORT).show()
