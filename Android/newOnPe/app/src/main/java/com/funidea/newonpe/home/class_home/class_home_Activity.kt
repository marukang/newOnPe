...
import com.funidea.newonpe.home.class_unit.class_unit_Activity
        ...
        classUnitListAdapter.setonItemClickListener(object : class_unit_list_Adapter.onItemClickListener
        {
            override fun item_click(position: Int) {
                ...
                if(nowdate<=class_unit_end_date_change.toInt()&&nowdate>=class_unit_start_date_change.toInt())
                {
                    ...
                    val intent = Intent(this@class_home_Activity, class_unit_Activity::class.java)
                ...
                {
                    custom_toast(this@class_home_Activity, "수업 기간이 아닙니다.")
                }
                else if(nowdate>class_unit_end_date_change.toInt())
                {
                    custom_toast(this@class_home_Activity, "기간이 만료 된 수업입니다.")
                }
            ...
            override fun onResponse(call: Call<ResponseBody>, response: Response<ResponseBody>)
            {
                try {
                    ...
                    if(!i.next().equals("fail"))
                    {
                        ...
                        save_SharedPreferences.save_shard(this@class_home_Activity, set_User_info.access_token)
                    ...
                    {
                        custom_toast(this@class_home_Activity, "인터넷 연결 상태를 확인해주세요.")
            ...
            override fun onResponse(call: Call<ResponseBody>, response: Response<ResponseBody>)
            {
                try {
                    ...
                    if(!i.next().equals("fail"))
                    {
                        ...
                        save_SharedPreferences.save_shard(this@class_home_Activity, access_token)
        ...
        serverConnection!!.get_student_class_record(student_id,access_token, class_code, class_unit_code).enqueue(object : Callback<ResponseBody> {
            override fun onResponse(call: Call<ResponseBody>, response: Response<ResponseBody>)
            {
                ...
                overridePendingTransition(R.anim.anim_slide_in_right, R.anim.anim_slide_out_left)
                    ...
                    {
                        custom_toast(this@class_home_Activity, "수업 참여 후 수업 현황을 조회해주세요.")
