...
class SNSLoginPage : CommonActivity()
{
    ...
    override fun init(savedInstanceState: Bundle?)
    {
        ...
        mELoginButton.setOnClickListener { onEmailLoginTry() }
    }
...
//                                        Log.d("debug", ">> [complexion] onNaverLoginTry OAuthLoginHandler authorizeInformation = $authorizeInformation")
    ...
    {
        val intent = Intent(this@SNSLoginPage, EmailLoginPage::class.java)
            ...
            override fun onResponse(call: Call<ResponseBody>, response: Response<ResponseBody>) {
                try {
                    ...
                    if (iterator.next() != "fail")
                    {
                        ...
                        CustomToast.show(this@SNSLoginPage, "자동 로그인이 되었습니다.")
