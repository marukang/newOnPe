            ...
            override fun onResponse(call: Call<ResponseBody>, response: Response<ResponseBody>)
            {
                try {
                    ...
                    if(!i.next().equals("fail"))
                    {
                        ...
                        Custom_Toast.custom_toast(this@class_message_answer_Activity, "정상적으로 삭제 되었습니다.")
                    ...
                    {
                        Custom_Toast.custom_toast(this@class_message_answer_Activity, "인터넷 연결 상태를 확인해주세요.")
                    }
