...
class pw_search_input_code_Activity : AppCompatActivity() {
    ...
    val confirm_button = View.OnClickListener {
        ...
        else
        {
            ...
            if(confirm_code_value.equals(confirm_code))
            {
                ...
                val intent = Intent(this, pw_search_change_Activity::class.java)
    ...
    private fun startTimer() {
        mCountDownTimer = object : CountDownTimer(mTimeLeftInMillis, 1000) {
            ...
            override fun onFinish() {
                ...
                Toast.makeText(this@pw_search_input_code_Activity, "입력 시간이 종료되었습니다.\n이전 화면으로 돌아갑니다.", Toast.LENGTH_SHORT).show()
                finish()
            }
        }.start()
        mTimerRunning = true
