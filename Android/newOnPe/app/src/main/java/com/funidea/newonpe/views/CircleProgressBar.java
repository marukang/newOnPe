...
public class CircleProgressBar extends View {
    ...
    private RectF rectF;
    private Paint   centerGroundPaint;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        centerGroundPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        centerGroundPaint.setColor(Color.BLACK);
        centerGroundPaint.setStyle(Paint.Style.FILL);
        centerGroundPaint.setStrokeWidth(strokeWidth);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int radius = (int) ((getWidth() / 2) - strokeWidth);
        canvas.drawCircle(centerX, centerY, radius, centerGroundPaint);
