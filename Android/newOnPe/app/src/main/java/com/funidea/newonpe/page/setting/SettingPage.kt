            ...
            override fun onResponse(call: Call<ResponseBody>, response: Response<ResponseBody>)
            {
                try {
                    ...
                    if(!i.next().equals("fail"))
                    {
                        ...
                        show(this@SettingPage, "푸시 알림 설정이 변경 되었습니다.")
                        }
                    }

                    else{
                        show(this@SettingPage, "인터넷 연결 상태를 다시 확인해주세요.")
                    }
            ...
            override fun onResponse(call: Call<ResponseBody>, response: Response<ResponseBody>)
            {
                try {
                    ...
                    if(!i.next().equals("fail"))
                    {
                        ...
                        show(this@SettingPage, "성공적으로 탈퇴가 완료되었습니다.")
