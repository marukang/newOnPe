            ...
            override fun onResponse(call: Call<ResponseBody>, response: Response<ResponseBody>) {
                try {
                    ...
                    if (!iterator.next().equals("fail"))
                    {
                        ...
                        Custom_Toast.custom_toast(this@SplashActivity, "자동 로그인이 되었습니다.")
                    ...
                    else
                    {
                        ...
                        Custom_Toast.custom_toast(this@SplashActivity, "아이디와 비밀번호를 확인해주세요.")
                        anim.setAnimationListener(object : Animation.AnimationListener {
                            override fun onAnimationStart(animation: Animation) {
                            ...
                            override fun onAnimationEnd(animation: Animation) {
                                ...
                                val intent = Intent(this@SplashActivity, login_page_Activity::class.java)
                                startActivity(intent)
                                finish()
                                overridePendingTransition(R.anim.fade_in, R.anim.fade_out)
