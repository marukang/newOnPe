 ...
 *
 */
public class CommonRecyclerAdapter extends RecyclerView.Adapter<CompositeViewHolder> implements ICommonListConstant {
    ...
    private final ICommonListStrategy mListStrategy;

    public CommonRecyclerAdapter(Context context, ICommonListStrategy strategy)
    {
        mContext = context;
        mLayoutInflater = LayoutInflater.from(context);
        mdArrayList = new ArrayList<>();
        mListStrategy = strategy;
    }
    ...
    public final CompositeViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
    {
        ...
        switch (viewType)
        {
            ...
            default:
                return (mListStrategy != null ? new CompositeViewHolder(mListStrategy.createItemView(parent, viewType)) : null);
        }
    }

    @Override
    public final void onBindViewHolder(@NotNull CompositeViewHolder holder, int position)
    {
        try
        {
            ...
            if (mListStrategy != null)
            {
                mListStrategy.drawItemView(holder,position, viewType,commonItem);
            }
        }
        catch (Exception e)
        {
