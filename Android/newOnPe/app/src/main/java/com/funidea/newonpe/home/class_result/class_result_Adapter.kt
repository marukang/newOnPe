...
class class_result_Adapter(context: Context, classResultItem : ArrayList<class_result_Item>?)
    : RecyclerView.Adapter<class_result_Adapter.ViewHolder>() {

    private val classResultItem: ArrayList<class_result_Item>?
    ...
    init {
        this.classResultItem = classResultItem
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, position: Int) {
        ...
        val position_item: class_result_Item = classResultItem!![position]
        ...
        viewHolder.result_score_time_exercise_title_textview.setText(position_item.content_name)
        viewHolder.result_score_time_exercise_category_textview.setText(position_item.content_category)
