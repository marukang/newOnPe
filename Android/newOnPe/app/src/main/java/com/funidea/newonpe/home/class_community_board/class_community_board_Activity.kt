...
import com.funidea.newonpe.home.show_photo_Activity
            ...
            override fun onResponse(call: Call<ResponseBody>, response: Response<ResponseBody>)
            {
                try {
                    ...
                    i =  result.keys()
                      ...
                      {
                          Custom_Toast.custom_toast(this@class_community_board_Activity, "인터넷 연결 상태를 확인해주세요.")
            ...
            override fun onResponse(call: Call<ResponseBody>, response: Response<ResponseBody>)
            {
                try {
                    ...
                    if(!i.next().equals("fail"))
                    {
                        ...
                        access_token = result.getString("student_token")
                        save_shard(this@class_community_board_Activity, access_token)
                        Custom_Toast.custom_toast(this@class_community_board_Activity, "게시글이 삭제되었습니다.")
                        finish()
                        overridePendingTransition(R.anim.anim_slide_in_right, R.anim.anim_slide_out_left)
