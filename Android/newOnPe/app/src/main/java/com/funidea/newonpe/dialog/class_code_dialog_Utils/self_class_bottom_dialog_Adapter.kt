 ...
 * 현재 사용 X
 */
class self_class_bottom_dialog_Adapter(context: Context, selfClassBottomDialogItem : ArrayList<self_class_bottom_dialog_Item>?)
    : RecyclerView.Adapter<self_class_bottom_dialog_Adapter.ViewHolder>() {

    private val selfClassBottomDialogItem: ArrayList<self_class_bottom_dialog_Item>?
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, position: Int) {
        ...
        val position_item: self_class_bottom_dialog_Item = selfClassBottomDialogItem!![position]
