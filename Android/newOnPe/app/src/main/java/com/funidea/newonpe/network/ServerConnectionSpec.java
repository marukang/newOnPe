 ...
 */
public interface ServerConnectionSpec
{
    //유저 로그인
    @FormUrlEncoded
    @POST(APP_LOGIN)
    ...
    @FormUrlEncoded
    @POST("users/getToken")
    Call<ResponseBody> get_import_token
    (
    ...
    @GET
    Call<ResponseBody> get_import_certification
    (
    ...
    (
            ...
            @Field("student_device_token") String student_device_token,
