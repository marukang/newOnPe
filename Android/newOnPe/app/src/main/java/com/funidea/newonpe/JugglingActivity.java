...
import com.funidea.newonpe.juggling.Juggling_Function;
import com.funidea.newonpe.juggling.Juggling_Information;
...
public class JugglingActivity extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    public Mat onCameraFrame(CameraBridgeViewBase.CvCameraViewFrame inputFrame) {
        ...
        if(Juggling_Information.array_count==-1){
            ...
            Intent intent = new Intent(JugglingActivity.this, GetDataActivity.class);
