...
class removeCell: UICollectionViewCell, UITextFieldDelegate {
    ...
    func btnAction(){
        if let password = textField.text {
            textField.text = nil
            delegate?.btnAction(password: password)
        }
    }
    ...
    func _label(label : UILabel){
        ...
        label.text = "탈퇴 시 본인 확인을 위해 비밀번호를 입력해주세요."
    ...
    func _textField(textField : UITextField){
        ...
        textField.placeholder = "현재 비밀번호 입력"
