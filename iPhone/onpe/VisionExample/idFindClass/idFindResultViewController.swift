//
//  IdFindResultViewController.swift
//  newOnProject
//
 ...
 */
class idFindResultViewController: UIViewController {
...
extension idFindResultViewController
{
    func setupLayout(){
    ...
    func _goTologinBtn(button : UIButton){
        ...
        button.addTarget(self, action: #selector(goTologinBtnAction), for: .touchUpInside)
