...
public class email_authentication_sendMailThread implements Runnable{
	...
	public email_authentication_sendMailThread(String mail, String code, JavaMailSender ms) {
	...
	public void run() {
		...
		try {
			...
			mailHelper.setText("<div style='width:100%; padding:20px 0; text-align:center;'><div style='vertical-align:center; display:inline-block; width:200px; padding:30px 5px;'>" +
					...
					"<div style='float:left; width:100%; text-align:center; font-size:18px; font-weight:bold;'>인증번호 : "+ code +"</div></div></div>", true);	// 내용 셋팅
