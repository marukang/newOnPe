	...
	$.extend(MediaElementPlayer.prototype, {
		...
		buildfullscreen: function(player, controls, layers, media) {
			...
			var t = this,
				normalHeight = 0,
				normalWidth = 0,
				normalTop = 0, // 16.03.03 박정민 : 좌표 복원값 추가
				normalLeft = 0, // 16.03.03 박정민 : 좌표 복원값 추가
		...
		enterFullScreen: function() {
			...
			normalTop = t.container.position().top;
			normalLeft = t.container.position().left;
		...
		exitFullScreen: function() {
			...
			t.container
				...
				.width(normalWidth)
				.height(normalHeight)
				.css({top:normalTop,left:normalLeft}); // 16.03.03 박정민 : 복원값 추가
