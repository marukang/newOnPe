			...
			<div class="wrapper">
				...
				<div class="box-wrap">
					<div class="box-content">						
							...
							<div class="form auto-w">
								<div class="field w69">
									<div class="field-inner">
										<label>제목</label>
										<input id="faq_title" type="text" class="w69" placeholder="FAQ 제목을 입력해주세요" value="${faq.faq_title}" disabled>
									</div>
								</div>
								...
								<div class="field w24">
									<div class="field-inner">
										<label>타입</label>
										<input id="faq_type" type="text" placeholder="FAQ 타입을 입력해주세요" value="${faq.faq_type}" disabled>
									</div>
								</div>
								...
								<div class="field w100">
									<div class="field-inner">
										<label>내용</label>
										<textarea id="faq_content" placeholder="FAQ 내용을 입력해주세요" disabled>${faq.faq_content}</textarea>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="btn-wrap">
							<button class="btn-sec" onclick="location.href='/teacher/service/faq_list'">목록</button>
						</div>
