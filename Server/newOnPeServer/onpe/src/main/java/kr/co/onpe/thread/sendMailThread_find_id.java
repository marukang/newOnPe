...
public class sendMailThread_find_id implements Runnable{
	...
	public sendMailThread_find_id(String mail, String teacher_id, JavaMailSender ms) {
	...
	public void run() {
		...
		try {
			...
			mailHelper.setText("<div style='width:100%; padding:20px 0; text-align:center;'><div style='vertical-align:center; display:inline-block; width:400px; padding:30px 5px;'>" +
					"<div style='float:left; width:100%; text-align:center; font-size:22px; font-weight:bold;'>온체육 아이디 찾기</div>" +
					"<div style='float:left; margin:10px 0; border-top:3px solid; width:100%; height:1px;'></div>" +
					"<div style='float:left; width:100%; text-align:center; font-size:18px; font-weight:bold;'>회원 아이디 : "+ teacher_id +"</div></div></div>", true);	// 내용 셋팅
