						...
						<div class="overflow">
							<table class="basic medium">
								...
								<c:forEach items="${notice_list}" var="notice_list">
									<tr class="notice_list_tr" onclick="location.href='/teacher/service/notice_detail?admin_notice_number=${notice_list.admin_notice_number}'">
	...
	$(document).ready(function(){
		...
		*/
		$("#search_btn").click(function(){
			...
			location.href="/teacher/service/notice_list?keyword="+$("#search_input").val()+"&option="+$("#option_selectBox option:selected").val();
		});
	});
	</script>
</html>
